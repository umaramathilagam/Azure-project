...
def generaetLogFile(batchResults,sqlsUrl,sqlServerFailedTable,userName,password,spark,sender,awsregion,accessid,accessKey):
    logResults=[]
    ...
    if logDF.count()!=0:
        ...
        if recordCount>0:
            ...
            #sendMail(recordCount,sender,awsregion,accessid,accessKey)

def sendMail(recordCount,sender,awsregion,accessid,accessKey):
...
def mainFunction():
    ...
    try:
       ...
       #
        ...
        sourceTablename="vw_Salesforce_SFHC_VBC_Patients_Incremental_Upload"
        #targettablename = os.environ['targettablename'] 
        targettablename="Account" 
        #sqljarpath = os.environ['sqljarpath'] 
        #sqljarpath="C:\\Users\\Ashwini\\OneDrive\\Desktop\\IncrementalPythonApp\\codeArea\\lib\\sqljdbc4-3.0.jar"
        sqljarpath="codeArea/lib/mssql-jdbc-10.2.1.jre8.jar"
        #sqlurl = os.environ['sqlurl']  
        #accessid = os.environ['ACCESS_ID']
        ...
        sqlurl = 'dataserver.sandbox.rcoanalytics.com'


        logtable="VBC_Extern.VBC_SFHC_Log"
        #sqlserverfailedtable = os.environ['sqlserverfailedtable']  
        sqlserverfailedtable="VBC_Extern.VBC_SFHC_P2P_IncrementalUpload_FailureLog"
        print(userName)
    ...
    try:
        ...
        #generaetLogFile(batchResults,sqlurl,sqlserverfailedtable,userName, password,spark,sender,awsregion,accessid,accessKey)
        bulk.close_job(job)
