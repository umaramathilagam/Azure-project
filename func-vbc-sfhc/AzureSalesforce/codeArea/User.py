...
import os
os.environ['SPARK_HOME']="/Library/Frameworks/Python.framework/Versions/3.7/lib/python3.7/site-packages/pyspark"
...
if __name__ == '__main__':
    ...
    csvfile = pd.read_csv("user.csv", header='infer')

    for index, col in credFile.iterrows():
        userName=col.sqlusername
        password=col.sqlpassword
        salesforceUsername=col.salesforceusername
        salesforcePassword=col.salesforcepassword
        securityToken=col.securitytoken
    ...
    spark = SparkSession \
        ...
        .config('spark.driver.extraClassPath', '/Users/suren/PycharmProjects/Python Project/sqljdbc4-3.0.jar') \
        .config('spark.executor.extraClassPath', '/Users/suren/PycharmProjects/Python Project/sqljdbc4-3.0.jar') \
        .getOrCreate()
